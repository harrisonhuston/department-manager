/* Class GraduateThesis extends Thesis and is a Concrete class within the Behavioral pattern, Template Method. The class
 * includes two overridden methods, completeCourses(Student student) and getAdvisor(Student student, FullTimeFaculty
 * advisor)
 */

class GraduateThesis extends Thesis{
