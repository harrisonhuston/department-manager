/* SubConcentration class implements CourseComponent and acts a Composite within the Structural Composite pattern.
...
public class SubConcentration  implements CourseComponent{
    private String name;
    private String description;
    private List<CourseComponent> components = new ArrayList<>();
    FullTimeFaculty coordinator;

    // constructor for subconcentration includes String name and description
    public SubConcentration(String name, String description) {
        this.name = name;
    ...
    @Override
    public void remove(CourseComponent component) { components.add(component); }
